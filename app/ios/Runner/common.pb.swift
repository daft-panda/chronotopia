...
struct Chronotopia_DateTime: Sendable {
  ...
  var timeOffset: Chronotopia_DateTime.OneOf_TimeOffset? = nil

  /// UTC offset. Must be whole seconds, between -18 hours and +18 hours.
  /// For example, a UTC offset of -4:00 would be represented as
  /// { seconds: -14400 }.
  var utcOffset: SwiftProtobuf.Google_Protobuf_Duration {
    get {
  ...
  /// Time zone.
  var timeZone: Chronotopia_TimeZone {
    get {
      if case .timeZone(let v)? = timeOffset {return v}
      return Chronotopia_TimeZone()
    }
  ...
  /// and future DateTimes in the affected range had already been stored).
  /// If omitted, the DateTime is considered to be in local time.
  enum OneOf_TimeOffset: Equatable, Sendable {
    /// UTC offset. Must be whole seconds, between -18 hours and +18 hours.
    /// For example, a UTC offset of -4:00 would be represented as
    /// { seconds: -14400 }.
    case utcOffset(SwiftProtobuf.Google_Protobuf_Duration)
    /// Time zone.
    case timeZone(Chronotopia_TimeZone)
...
struct Chronotopia_TimeZone: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// UUID type
struct Chronotopia_UUID: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Chronotopia_LatLon: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Chronotopia_Point: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var latlon: Chronotopia_LatLon {
    get {return _latlon ?? Chronotopia_LatLon()}
    set {_latlon = newValue}
  }
  /// Returns true if `latlon` has been explicitly set.
  var hasLatlon: Bool {return self._latlon != nil}
  /// Clears the value of `latlon`. Subsequent reads from it will return its default value.
  mutating func clearLatlon() {self._latlon = nil}
  ...
  var elevation: Float {
    get {return _elevation ?? 0}
    set {_elevation = newValue}
  }
  /// Returns true if `elevation` has been explicitly set.
  var hasElevation: Bool {return self._elevation != nil}
  /// Clears the value of `elevation`. Subsequent reads from it will return its default value.
  mutating func clearElevation() {self._elevation = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _latlon: Chronotopia_LatLon? = nil
  fileprivate var _dateTime: Chronotopia_DateTime? = nil
  fileprivate var _label: String? = nil
  fileprivate var _note: String? = nil
  fileprivate var _elevation: Float? = nil
}

struct Chronotopia_Points: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var points: [Chronotopia_Point] = []
...
extension Chronotopia_DateTime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.hours) }()
      case 5: try { try decoder.decodeSingularUInt32Field(value: &self.minutes) }()
      case 6: try { try decoder.decodeSingularUInt32Field(value: &self.seconds) }()
      case 7: try { try decoder.decodeSingularUInt32Field(value: &self.nanos) }()
      case 8: try {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.hours != 0 {
      try visitor.visitSingularUInt32Field(value: self.hours, fieldNumber: 4)
    }
    if self.minutes != 0 {
      try visitor.visitSingularUInt32Field(value: self.minutes, fieldNumber: 5)
    }
    if self.seconds != 0 {
      try visitor.visitSingularUInt32Field(value: self.seconds, fieldNumber: 6)
    }
    if self.nanos != 0 {
      try visitor.visitSingularUInt32Field(value: self.nanos, fieldNumber: 7)
    }
  ...
  static func ==(lhs: Chronotopia_DateTime, rhs: Chronotopia_DateTime) -> Bool {
...
extension Chronotopia_TimeZone: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Chronotopia_TimeZone, rhs: Chronotopia_TimeZone) -> Bool {
...
extension Chronotopia_UUID: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Chronotopia_UUID, rhs: Chronotopia_UUID) -> Bool {
...
extension Chronotopia_LatLon: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LatLon"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "lat"),
    2: .same(proto: "lon"),
  ]
  ...
  static func ==(lhs: Chronotopia_LatLon, rhs: Chronotopia_LatLon) -> Bool {
...
extension Chronotopia_Point: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._latlon) }()
      ...
      case 6: try { try decoder.decodeSingularFloatField(value: &self._elevation) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._elevation {
      try visitor.visitSingularFloatField(value: v, fieldNumber: 6)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Chronotopia_Point, rhs: Chronotopia_Point) -> Bool {
    if lhs._latlon != rhs._latlon {return false}
    if lhs._dateTime != rhs._dateTime {return false}
    if lhs._label != rhs._label {return false}
    if lhs._note != rhs._note {return false}
    if lhs._elevation != rhs._elevation {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Chronotopia_Points: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Points"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "points"),
  ]
  ...
  static func ==(lhs: Chronotopia_Points, rhs: Chronotopia_Points) -> Bool {
